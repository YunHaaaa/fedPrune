...
class Client:
    ...
    def update_to_global_mask(self,global_params=None):
        for name, mask_params in global_params.items():
            if name.endswith('mask'):
                self.net[name] = mask_params
    ...
    def train(self, global_params=None, initial_global_params=None,
        ...
        for epoch in range(self.local_epochs):
            ...
            for inputs, labels in self.train_data:
                ...
                self.update_to_global_mask(global_params)
...
for server_round in tqdm(range(args.rounds)):
    ...
    for client_id in client_indices:
        ...
        train_result = client.train(global_params=global_params, initial_global_params=initial_global_params,
                                    ...
                                    readjust=False, sparsity=round_sparsity)
